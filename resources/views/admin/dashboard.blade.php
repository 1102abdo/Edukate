                        ...
                        <tbody>
                            <tr>
                                <td
                                    ...
                                    <div class="flex items-center px-2 py-1">
                                        <div>
                                            <img src="{{ asset('assets-admin') }}/assets/img/icons/flags/US.png"
                                                alt="Country flag" />
                                        </div>
                                        <div class="ml-6">
                                            <p
                            ...
                            <tr>
                                <td
                                    ...
                                    <div class="flex items-center px-2 py-1">
                                        <div>
                                            <img src="{{ asset('assets-admin') }}/assets/img/icons/flags/DE.png"
                                                alt="Country flag" />
                                        </div>
                                        <div class="ml-6">
                                            <p
                            ...
                            <tr>
                                <td
                                    ...
                                    <div class="flex items-center px-2 py-1">
                                        <div>
                                            <img src="{{ asset('assets-admin') }}/assets/img/icons/flags/GB.png"
                                                alt="Country flag" />
                                        </div>
                                        <div class="ml-6">
                                            <p
                            ...
                            <tr>
                                <td class="p-2 align-middle bg-transparent border-0 w-3/10 whitespace-nowrap">
                                    <div class="flex items-center px-2 py-1">
                                        <div>
                                            <img src="{{ asset('assets-admin') }}/assets/img/icons/flags/BR.png"
                                                alt="Country flag" />
                                        </div>
                                        <div class="ml-6">
                                            <p
