   ...
   @section('home-active','active')
    ...
    @include('front.partials.special-header')
@endsection
   @section('content')
   ...
   <!-- About Start -->
            ...
            <div class="row">
                <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="{{asset ('assets-front') }}/img/about.jpg" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-7">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="{{asset ('assets-front') }}/img/feature.jpg" style="object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid px-0 py-5">
        ...
        <div class="owl-carousel courses-carousel">
            ...
            <div class="courses-item position-relative">
                <img class="img-fluid" src="{{asset ('assets-front') }}/img/courses-4.jpg" alt="">
                <div class="courses-text">
                    <h4 class="text-center text-white px-3">Web design & development courses for beginners</h4>
                    <div class="border-top w-100 mt-3">
                        <div class="d-flex justify-content-between p-4">
            ...
            <div class="courses-item position-relative">
                <img class="img-fluid" src="{{asset ('assets-front') }}/img/courses-5.jpg" alt="">
                <div class="courses-text">
                    <h4 class="text-center text-white px-3">Web design & development courses for beginners</h4>
                    <div class="border-top w-100 mt-3">
                        <div class="d-flex justify-content-between p-4">
            ...
            <div class="courses-item position-relative">
                <img class="img-fluid" src="{{asset ('assets-front') }}/img/courses-6.jpg" alt="">
                <div class="courses-text">
                    <h4 class="text-center text-white px-3">Web design & development courses for beginners</h4>
                    <div class="border-top w-100 mt-3">
                        <div class="d-flex justify-content-between p-4">
                    ...
                    <div class="owl-carousel testimonial-carousel">
                        <div class="bg-white p-5">
                            ...
                            <div class="d-flex flex-shrink-0 align-items-center mt-4">
                                <img class="img-fluid mr-4" src="{{asset ('assets-front') }}/img/testimonial-2.jpg" alt="">
                                <div>
                                    <h5>Student Name</h5>
                        ...
                        <div class="bg-white p-5">
                            ...
                            <p>Sed et elitr ipsum labore dolor diam, ipsum duo vero sed sit est est ipsum eos clita est ipsum. Est nonumy tempor at kasd. Sed at dolor duo ut dolor, et justo erat dolor magna sed stet amet elitr duo lorem</p>
                            <div class="d-flex flex-shrink-0 align-items-center mt-4">
                                <img class="img-fluid mr-4" src="{{asset ('assets-front') }}/img/testimonial-1.jpg" alt="">
                                <div>
                                    <h5>Student Name</h5>
                                    <span>Web Design</span>
                                </div>
