        ...
        <section class="signup">
            <div class="container">
                <div class="signup-content">
                    <form method="POST" id="signup-form" class="signup-form" action="{{ route('front.register') }}">
                        @csrf
                    ...
                    <p class="loginhere">
                        Have already an account ? <a href="{{ route('front.login') }}" class="loginhere-link">Login
                            here</a>
                    </p>
                </div>
            </div>
